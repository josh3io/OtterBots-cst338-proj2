...
/**
 * Description: Show the leaderboard Author: Josh Goldberg Since: 2025.12.07
 */
public class LeaderboardActivity extends AppCompatActivity {

  private RockPaperScissorsRepository repository;

  static Intent leaderboardActivityIntentFactory(Context context, String userName, int userId,
      boolean isAdmin) {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    LeaderboardViewModel leaderboardViewModel = new ViewModelProvider(this).get(
    ...
    final LeaderboardAdapter adapter = new LeaderboardAdapter(
        new LeaderboardAdapter.LeaderboardDiff());
