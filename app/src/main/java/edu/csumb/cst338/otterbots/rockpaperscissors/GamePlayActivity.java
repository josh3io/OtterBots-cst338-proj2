...
public class GamePlayActivity extends AppCompatActivity {
    ...
    // Fields for tracking the player (retrieved from Intent)
    private int userId;
    ...
    private void updateDatabaseStats(int outcome) {
        ...
        LiveData<UserStats> userStatsLiveData =
                repository.getUserStatsByUserId(userId);
    ...
    private int determineOutcome() {
        ...
        if (userCurrentGuess.equals(GAME_CHOICES.get(0)) && npcCurrentGuess.equals(GAME_CHOICES.get(2)) ||
                userCurrentGuess.equals(GAME_CHOICES.get(1)) && npcCurrentGuess.equals(GAME_CHOICES.get(0)) ||
                userCurrentGuess.equals(GAME_CHOICES.get(2)) && npcCurrentGuess.equals(GAME_CHOICES.get(1))) {
    ...
    /**
     * Factory method for creating an Intent that launches gameplay
