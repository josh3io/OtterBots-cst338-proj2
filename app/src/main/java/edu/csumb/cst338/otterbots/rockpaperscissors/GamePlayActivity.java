...
public class GamePlayActivity extends AppCompatActivity {
  ...
  private int determineOutcome() {
    ...
    if (userCurrentGuess.equals(GAME_CHOICES.get(0)) && npcCurrentGuess.equals(
        GAME_CHOICES.get(2))) {
    ...
    if (userCurrentGuess.equals(GAME_CHOICES.get(1)) && npcCurrentGuess.equals(
        GAME_CHOICES.get(0))) {
    ...
    if (userCurrentGuess.equals(GAME_CHOICES.get(2)) && npcCurrentGuess.equals(
        GAME_CHOICES.get(1))) {
