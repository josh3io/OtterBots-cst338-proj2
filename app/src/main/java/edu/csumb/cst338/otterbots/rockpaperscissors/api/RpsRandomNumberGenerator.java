...
/**
 * Description: Call an API to get a truly random number, not pseudorandom
 * get 100 at a time and store locally.
 * when the list gets low, get more.
...
public class RpsRandomNumberGenerator {
    ...
    /**
     * Call the API to get more numbers to store in the singleton.
     * the API provider likes us to make batch calls.
     */
